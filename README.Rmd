...
Then opening the `sparkts.Rproj` file will give you access to the Build tab from which you can "Install and Restart" (or Ctrl + Shift + B / Cmd + Shift + B). This will build the package, install it, retart R and load the package.
