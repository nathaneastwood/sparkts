...
Then opening the `sparkts.Rproj` file will give you access to the Build tab from which you can "Install and Restart" (or Ctrl + Shift + B for windows or Cmd + Shift + B for Mac). This will build the package, install it, retart R and load the package.
